// ================================================================
// OBJECTION HANDLER - COMPLETE WORKING VERSION
// ================================================================
...
(function() {
    ...
    const ObjectionHandler = {
        ...
        categories: {
            ...
            gatekeeper: {
                ...
                objections: [
                    ...
                    {
                        id: 'not_available',
                        objection: '"The owner is busy right now."',
                        response: 'No worries, I can call back later. What time would be better to reach them?',
                        tip: 'Be patient and ask for a specific time.'
                    },
                    {
                        id: 'forward_call',
                        objection: '"I\'ll take a message."',
                        response: 'I really appreciate that. Could you let them know that someone from a local marketing firm called about their online presence? I\'ll follow up later today.',
                        tip: 'Be polite and professional, leave a clear message.'
                    },
                    {
                        id: 'not_interested_gatekeeper',
                        objection: '"We\'re not interested."',
                        response: 'I understand. We actually have a free website preview already built for your business, so we wanted to reach out. Could I leave my name and number just in case?',
                        tip: 'Keep it brief and leave the door open with a free offer.'
                    }
                ]
            }
        },
        ...
        attachKeyboardShortcut: function() {
        ...
        _tryAttachButton: function() {
            ...
            // Also find any buttons with objection class
            document.querySelectorAll('.objection-btn, [data-action="objection"]').forEach(btn => {
                if (!btn._handlerAttached) {
                    this._attachButtonHandler(btn);
                }
            });
        },
        ...
        attachCardEvents: function(overlay) {
            ...
            cardsContainer.addEventListener('click', (e) => {
                ...
                if (e.target.closest('.objection-copy-btn-modal') || 
                    e.target.closest('.objection-practice-btn-modal')) {
                    return;
                }
            ...
            if (revealBtn) {
                revealBtn.addEventListener('click', () => {
                    ...
                    if (recommendedText) {
                        ...
                        recommendedText.classList.toggle('visible', isHidden);
